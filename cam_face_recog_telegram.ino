...
const char* ssid = "Santosh";  //WiFi Name
const char* password = "santosh2";  //WiFi Password

// Use @myidbot to find out the chat ID of an individual or a group
// You need to click "start" on a bot before it can message you 
// Initialize Telegram BOT
String chatId = "6324285270";
String BOTtoken = "6324285270:AAH55Qf478wx8bgtuPxURys3G0SfnbCyWQ0";
